...
export const SLOT_COUNT = 8; // günlük ders saati sayısı
...
export const INITIAL_LESSONS: Omit<Lesson, 'id'>[] = [
  { name: 'Türkçe', color: '#E57373', weeklyLimit: 8, gradeLevel: 3 },
  { name: 'Matematik', color: '#64B5F6', weeklyLimit: 5, gradeLevel: 3 },
  { name: 'Hayat Bilgisi', color: '#81C784', weeklyLimit: 3, gradeLevel: 3 },
